...
* 👨🏻‍🔬 Atuei em uma Iniciação Científica (IC) na UFRGS em uma pesquisa sobre evolução estelar de Anãs Brancas com os professores Kepler de Souza Oliveira Filho e Alejandra Daniela Romero como orientadores no ano de 2025;
* 👨🏻‍🚀 Desde pequeno sou apaixonado pelo espaço e o mais perto que posso estar dele é estudando e fazendo astrofotografias:
* 🖥️ Sei Python, LaTeX, o básico de HTML e um pouco de Linux, visto na cadeira de Física Computacional I, Física Computacional II e Programação em Python do meu curso;
